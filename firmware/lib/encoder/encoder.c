/* -----------------------------------------------------------------------------
 * Файл с исходным кодом библиотеки для работы со встроенным энкодером
 * ----------------------------------------------------------------------------- */
#include "encoder.h"
#include "timer.h"

/**
 * @brief Чтение пина порта
...
/**
 * @brief Функция возвращает событие изменение энкодера
 * @return 	0 - без изменений
 * 			1 - вращение по часовой стрелке
 * 			2 - вращение против часовой стрелке
 * 			3 - Нажатие на энкодер
 */
